      ...
      <section className="container-page py-16 sm:py-20">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr] lg:gap-14">
          ...
          <aside className="space-y-5">
            <div className="rounded-2xl bg-white p-7 shadow-lift ring-1 ring-paper-200">
              <h2 className="font-semibold text-navy-900">Reach us directly</h2>
              <ul className="mt-5 space-y-4 text-sm">
                <li className="flex items-start gap-3">
                  <PhoneIcon className="mt-0.5 h-4.5 w-4.5 shrink-0 text-navy-700" />
                  <div>
                    <a
                      href={site.contact.phoneHref}
                      className="font-semibold text-navy-900 transition-colors hover:text-navy-800"
                    >
                      {site.contact.phone}
                    </a>
                    <p className="mt-0.5 text-navy-800/55">
                ...
                {site.contact.email && (
                  <li className="flex items-start gap-3">
                    <MailIcon className="mt-0.5 h-4.5 w-4.5 shrink-0 text-navy-700" />
                    <a
                      href={`mailto:${site.contact.email}`}
                      className="break-all text-navy-800/80 transition-colors hover:text-navy-800"
                    >
                      {site.contact.email}
                    </a>
                  </li>
                ...
                <li className="flex items-start gap-3">
                  <MapPinIcon className="mt-0.5 h-4.5 w-4.5 shrink-0 text-navy-700" />
                ...
                <li className="flex items-start gap-3">
                  <InstagramIcon className="mt-0.5 h-4.5 w-4.5 shrink-0 text-navy-700" />
                  <a
                    href={site.social.instagram}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-navy-800/80 transition-colors hover:text-navy-800"
                  >
            ...
            <div className="rounded-2xl bg-white p-7 shadow-lift ring-1 ring-paper-200">
              <h2 className="flex items-center gap-2 font-semibold text-navy-900">
                <ClockIcon className="h-4.5 w-4.5 text-navy-700" />
                Hours
              </h2>
              <dl className="mt-4 space-y-2 text-sm text-navy-800/75">
                <div>{site.hours.weekdays}</div>
                <div>{site.hours.saturday}</div>
                <div>{site.hours.sunday}</div>
              </dl>
              {site.hours.emergencyNote && (
                <p className="mt-5 rounded-xl bg-gold-400/12 px-4 py-3 text-sm leading-relaxed text-navy-900 ring-1 ring-gold-400/30">
                  {site.hours.emergencyNote}
                </p>
              )}
            </div>

            <div className="rounded-2xl bg-navy-950 p-7 text-paper-100">
              <h2 className="font-semibold text-paper-50">
